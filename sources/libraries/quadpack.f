...
c
     ...
     *  blist,b1,b2,dabs,defabs,defab1,defab2,dmax1,d1mach,
     *  elist,epmach,
...
c
        ...
        b2 = blist(maxerr)
        if(keyf.eq.1) 
     1      call dqk15(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.2) 
     1      call dqk21(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.3) 
     1      call dqk31(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.4) 
     1      call dqk41(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.5) 
     1      call dqk51(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.6) 
     1      call dqk61(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.1) 
     1      call dqk15(f,a2,b2,area2,error2,resabs,defab2)
        if(keyf.eq.2) 
     1      call dqk21(f,a2,b2,area2,error2,resabs,defab2)
        if(keyf.eq.3) 
     1      call dqk31(f,a2,b2,area2,error2,resabs,defab2)
        if(keyf.eq.4) 
     1      call dqk41(f,a2,b2,area2,error2,resabs,defab2)
        if(keyf.eq.5) 
     1      call dqk51(f,a2,b2,area2,error2,resabs,defab2)
        if(keyf.eq.6) 
     1      call dqk61(f,a2,b2,area2,error2,resabs,defab2)
c
...
c
        ...
        b2 = blist(maxerr)
        if(keyf.eq.1) 
     1      call qk15(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.2) 
     1      call qk21(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.3) 
     1      call qk31(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.4) 
     1      call qk41(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.5) 
     1      call qk51(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.6) 
     1      call qk61(f,a1,b1,area1,error1,resabs,defab1)
        if(keyf.eq.1) 
     1      call qk15(f,a2,b2,area2,error2,resabs,defab2)
        if(keyf.eq.2) 
     1      call qk21(f,a2,b2,area2,error2,resabs,defab2)
        if(keyf.eq.3) 
     1      call qk31(f,a2,b2,area2,error2,resabs,defab2)
        if(keyf.eq.4) 
     1      call qk41(f,a2,b2,area2,error2,resabs,defab2)
        if(keyf.eq.5) 
     1      call qk51(f,a2,b2,area2,error2,resabs,defab2)
        if(keyf.eq.6) 
     1      call qk61(f,a2,b2,area2,error2,resabs,defab2)
c
c           improve previous approximations to integral
c           and error and test for accuracy.
c
...
c
      real a,absc,abserr,b,centr,dhlgth,epmach,f,fc,fsum,fval1,fval2,
     *  fv1,fv2,hlgth,resabs,resg,resk,reskh,result,r1mach,
     * uflow,wg,wgk,
     *  xgk
      integer j,jtw,jtwm1
      external f
