module Magnetic_configuration
   ...
   subroutine Write_Magnetic_Configuration
     ...
     do k = 1, N_modes
        write(21,*) mn(k,:), B_mnc(k), B_mnc(k)/B00        
     end do 
     close(21)
  ...
  subroutine read_boozer_xform_output(s0)
    ...
    subroutine read_profiles
       ...
       do i = 2, Ns 
          write(21,*) ss(i), iota_s(i), psi_s(i), psi_p_s(i), B_theta_s(i), B_zeta_s(i) 
       end do         
       close(21) 
    ...
    subroutine read_magnetic_field_modes
	   ...
	   do j = 1, Ns_b
	      ...
	      do i = 1, mnboz_b
	         ...
	         write(21,*) 1d0*j, 1d0*mn_s(i,:), B_mnc_s(i,j), B_mns_s(i,j)	
	         if( bigger_earth_field(i) .and. Stellarator_symmetry ) & 
	         write(21,*) 1d0*j, 1d0*mn_s(i,:), B_mnc_s(i,j) 	      
	      end do
	   end do 
	   close(21)	
