          ...
          do j = 1, M_zeta 
             do i = 1, M_theta 
                ...
                do k = 1, M_xi
                   ...
                   write(*,'(9999e1.24)') nu(i_nu), E_rho(i_E_rho), &
                   ...
                   write(221,'(9999e1.24)') nu(i_nu), E_rho(i_E_rho), &
                                       real(N_theta(i)), real(N_zeta(j)), real(N_xi(k)), &
                                       Gamma(1,1,i_nu,i_E_rho,j), Gamma(3,1,i_nu,i_E_rho,j), &
                                       Gamma(1,3,i_nu,i_E_rho,j), Gamma(3,3,i_nu,i_E_rho,j), &
                                       Gamma_33_Spitzer(i_nu,i_E_rho,j), &
  ...
  subroutine Monoenergetic_Database_Example_1   
    ...
    do j = 1, 6, 5!10!, 5 !N_E_rho
       ...
       do i = 1, N_nu
          ...
          call system_clock(c1)
          t0 = c0 / rate ; t1 = c1 / rate ! Instants of time in seconds
          write(*,'(9999e1.24)') nu(i), E_rho(j), Gamma(1,1,i,j), Gamma(3,1,i,j), Gamma(1,3,i,j), Gamma(3,3,i,j), Gamma_33_Spitzer(i,j), t1-t0, &
                            real(N_theta) ,  real(N_zeta) ,  real(N_xi)  
          write(1221,'(9999e1.24)') nu(i), E_rho(j), Gamma(1,1,i,j), Gamma(3,1,i,j), Gamma(1,3,i,j), Gamma(3,3,i,j), Gamma_33_Spitzer(i,j), t1-t0, &
                            real(N_theta) ,  real(N_zeta) ,  real(N_xi)  
          write(2221,'(9999e1.24)') nu(i), E_rho(j), Gamma(1,1,i,j), Gamma(3,1,i,j), Gamma(1,3,i,j), Gamma(3,3,i,j), Gamma_33_Spitzer(i,j), t1-t0, &
                            real(N_theta) ,  real(N_zeta) ,  real(N_xi)  
