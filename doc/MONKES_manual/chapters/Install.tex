...
In this section it is sketched how to install {\MONKES}. 
...
\listings{../../bin/Makefile}{Compiler selection}{LFLAGS}{\texttt{Makefile}}{lst:LAPACK_linking}
 ...
 \begingroup
 \listings{../../bin/Makefile}{main_monkes.x:}{f90comp}{\texttt{Makefile}}{lst:main_MONKES_compiling_instruction}
 \endgroup