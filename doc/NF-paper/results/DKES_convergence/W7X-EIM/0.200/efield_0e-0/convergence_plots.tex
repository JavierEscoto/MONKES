...
%			scaled y ticks=base 10:2,
    ...
    \foreach \c in {5,6,7,8,9}{
    	\begin{tikzpicture}
    		\begin{axis}[
    			...
    			\addplot[forget plot, name path=Upper2,blue!20, 
    			domain = 20:200] {(0.35610E+00	+ 0.37192E+00)/2*1.05 };	
    			\addplot[forget plot, name path=Lower2,blue!20, 
    			domain = 20:200] {(0.35610E+00	+ 0.37192E+00)/2*0.95 };		
    			\addplot[blue!20] fill between[of=Upper2 and Lower2];
    			\addlegendentry{ $\mathcal{R}_{5}$ DKES}	
    			
    			
    			\addplot[forget plot, name path=Upper2,red!20, 
    			domain = 20:200] {0.3593392335766615E+00*1.05 };	
    			\addplot[forget plot, name path=Lower2,red!20, 
    			domain = 20:200] {0.3593392335766615E+00*0.95 };		
    ...
    \begin{tikzpicture}
    	\begin{axis}[
    		...
    		\addplot[forget plot, name path=Upper2,blue!20, 
    		domain = 5:9] {(0.35610E+00	+ 0.37192E+00)/2*1.05 };	
    		\addplot[forget plot, name path=Lower2,blue!20, 
    		domain = 5:9] {(0.35610E+00	+ 0.37192E+00)/2*0.95 };		
    		\addplot[blue!20] fill between[of=Upper2 and Lower2];
    		\addlegendentry{ $\mathcal{R}_{5}$ DKES}	
    		
    		
    		\addplot[forget plot, name path=Upper2,red!20, 
    		domain = 5:9] {0.3593392335766615E+00*1.05 };	
    		\addplot[forget plot, name path=Lower2,red!20, 
    		domain = 5:9] {0.3593392335766615E+00*0.95 };		
    		\addplot[red!20] fill between[of=Upper2 and Lower2];
    		\addlegendentry{ $\mathcal{R}_{5}$ MONKES}	
